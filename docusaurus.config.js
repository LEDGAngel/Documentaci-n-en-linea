...
const config = {
  title: 'Ágata Planner',
  tagline: 'Documentación en línea',
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Ágata Planner Documentation',
        logo: {
          alt: 'My Site Logo',
          src: 'img/logo.png',
        },
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Ágata Planner Documentación, Inc. Built with Docusaurus.`,
      },
      prism: {
